...
?>
	<p class="lead"><a href="category_list.php">Kategori</a> > <?php echo $catName; ?></p>
...
?>
	<div class="row">
		...
		<div class="col-md-7">
			...
			<a href="book.php?bookisbn=<?php echo $row['book_isbn'];?>" class="btn btn-primary">Dapatkan Detail</a>
		</div>
	</div>
	<br>
<?php
